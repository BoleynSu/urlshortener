...
COPY ./ ./
RUN mvn package
RUN mvn help:evaluate -q -Dexpression=project.version -DforceStdout > version
RUN mv target/urlshortener-$(cat version)-jar-with-dependencies.jar urlshortener.jar
